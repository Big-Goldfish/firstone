...
<section>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo U('');?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="请输入菜单名称" value='<?php echo ($lists["name"]); ?>'/>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName">菜单路径</label>
                                <input type="text" name="path" class="form-control"  placeholder="请输入菜单路径" value='<?php echo ($lists["path"]); ?>'/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control " name="intro" placeholder="请输入菜单简介"><?php echo ($lists["intro"]); ?></textarea>
                            </div>
    ...
    <script type="text/javascript">
        ...
        <?php if(isset($lists)): ?>//获取所有被关联的菜单
        var permission_ids = <?php echo ($lists["permission_ids"]); ?>;
