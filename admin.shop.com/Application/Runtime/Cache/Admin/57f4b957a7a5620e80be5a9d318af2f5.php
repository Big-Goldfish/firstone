            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo U('pics');?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row imgBox">
                            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div style="float: left;">
                                    <div>
                                        <img src="<?php echo ($data["path"]); ?>" alt="加载失败"  style="width: 200px; height: 200px" />
                                        <a data-href="<?php echo U('pic_delete', ['id' => $data['id'],'goods_id' => $data['goods_id']]);?>"  data-toggle="modal" data-target="#myModal" class="btn btn-danger btn-xs deleteBtn">删除</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?php echo U('pic_delete', ['id' => $data['id']]);?>" id="deleteTrue" class="btn btn-primary">滚！狠心删除</a>
                    </div>
                </div>
            </div>
        </div>
