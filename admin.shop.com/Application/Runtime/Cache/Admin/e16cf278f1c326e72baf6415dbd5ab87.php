                    ...
                    <div class="panel-body">
                        <form role="form" action="<?php echo U('add');?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputName">文章主题</label>
                                <input type="text" name="name" class="form-control" id="exampleInputName" placeholder="请输入品牌名称" value='<?php echo ($row["name"]); ?>'/>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputIntro">文章分类</label>
                                <select name="article_category_id">
                                    <?php if(is_array($rows)): $i = 0; $__LIST__ = $rows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["id"]); ?>"><?php echo ($row["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputIntro">文章简介</label>
