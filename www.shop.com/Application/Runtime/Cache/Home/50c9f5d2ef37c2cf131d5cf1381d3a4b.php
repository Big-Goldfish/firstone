	...
	<body>
		...
		<div class="panel header">
			...
			<div class="top_menu">
				...
				<p class="not_login">
					<a href="<?php echo U('Login/index');?>">登录</a><span class="spliter">|</span>
		...
		<div class="panel center">
			...
			<form action="<?php echo U('Login/login');?>" method="post">
				<ul>
					<li>账号　<input type="text" name="username" placeholder="请输入注册账号或昵称"></input></li>
					<li>密码　<input type="password" name="password" placeholder="请输入密码"></input></li>
					<li>　　　<button class="submit">登　录</button></li>
					<li><a href="">忘记密码？</a>　<a href="<?php echo U('Member/index');?>">免费注册</a></li>
				</ul>
