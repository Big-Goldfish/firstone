...
<div class="panel header">
	...
	<div class="top_menu">
		...
		<p class="not_login">
			<?php if(isset($session)): echo $session['username'];?>
				<?php else: ?>
				<a href="<?php echo U('Login/index');?>">登录</a><span class="spliter">|</span><?php endif; ?>
...
<div class="container center">
	<div class="panel">
		<form action="<?php echo U('Cart/ucart');?>" method="post">
		<p class="uposition">你的当前位置：<a href="index.html">首页</a><span class="spliter">></span><a href="index.html#new_product">新品上市</a><span class="spliter">></span><a href="">正宗武夷山大红袍茶叶500g</a></p>
		<div class="description">
			<p class="title">特级大红袍 武夷岩茶 森舟茶叶礼盒 武夷山茶叶500g散装乌龙茶</p>
			<p class="subtitle">惊喜大桶装 超值500g 武夷正宗 口感醇厚</p>
			<dl>
				<dt>价格</dt>
				<dd class="price">￥<?php echo ($goods["market_price"]); ?></dd>
				<dt>促销价</dt>
				<dd class="promotional_price">￥<?php echo ($goods["shop_price"]); ?></dd>
				<dt>月销量</dt>
				...
				<dt>数量</dt>
				<dd class="amount"><button class="decrease">-</button><input type="text" name="amount" value="1"/><button class="increase">+</button></dd>
				<dt>库存</dt>
				<dd class="inventory"><?php echo ($goods["stock"]); ?>件</dd>
				<dd class="options"><button onclick="javascript:window.location.href='<?php echo U('Cart/index');?>'"><img src="/Public/img/ljgm.png"> 立即购买</button> <button type="submit"><img src="/Public/img/sygw.png"> 加入购物车</button></dd>
		...
		<div class="sample">
			<div class='lightSlider-content'>
				<ul>
					<?php if(is_array($goods_gallery)): $i = 0; $__LIST__ = $goods_gallery;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good_gallery): $mod = ($i % 2 );++$i;?><li data-thumb="/Public/img/product/thumb/spxq-zst1.jpg">
						<img src="<?php echo ($good_gallery["path"]); ?>">
		...
		<div class="details">
			...
			<dl>
				...
				<dt>商品详情</dt>
				<dd class="picture">
					<img src="/Public/img/product/tu1.jpg" />
					<img src="/Public/img/product/tu2.jpg" />
					<img src="/Public/img/product/tu3.jpg" />
					<img src="/Public/img/product/tu4.jpg" />
					<img src="/Public/img/product/tu5.jpg" />
				</dd>
